...
public class TagsEditText extends AppCompatAutoCompleteTextView {
  ...
  private ArrayList<TagSpan> mTagSpans = new ArrayList<>();
  ...
  public void setTags(CharSequence... tags) {
    ...
    for (int i = 0; i < length; i++) {
      ...
      String source = mIsSpacesAllowedInTags ? tags[i].toString().trim()
          : tags[i].toString().replaceAll(" ", "");
      tag.setSource(source);
      tag.setSpan(true);
      mTags.add(tag);
  ...
  public Parcelable onSaveInstanceState() {
    ...
    bundle.putParcelableArrayList(TAGS, mTags);
  ...
  public void onRestoreInstanceState(Parcelable state) {
    ...
    if (state instanceof Bundle) {
      ...
      ArrayList<Tag> tags = bundle.getParcelableArrayList(TAGS);
  ...
  private void init(@Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    if (attrs == null) {
      ...
      TypedArray typedArray =
          context.obtainStyledAttributes(attrs, R.styleable.TagsEditText, defStyleAttr,
              defStyleRes);
      try {
        mIsSpacesAllowedInTags =
            typedArray.getBoolean(R.styleable.TagsEditText_allowSpaceInTag, false);
        ...
        mDrawablePadding =
            typedArray.getDimensionPixelOffset(R.styleable.TagsEditText_tagsCloseImagePadding,
                ResourceUtils.getDimensionPixelSize(context, R.dimen.defaultTagsCloseImagePadding));
        mTagsPaddingRight =
            typedArray.getDimensionPixelSize(R.styleable.TagsEditText_tagsPaddingRight,
                ResourceUtils.getDimensionPixelSize(context, R.dimen.defaultTagsPadding));
        mTagsPaddingLeft =
            typedArray.getDimensionPixelSize(R.styleable.TagsEditText_tagsPaddingLeft,
                ResourceUtils.getDimensionPixelSize(context, R.dimen.defaultTagsPadding));
        mTagsPaddingTop = typedArray.getDimensionPixelSize(R.styleable.TagsEditText_tagsPaddingTop,
            ResourceUtils.getDimensionPixelSize(context, R.dimen.defaultTagsPadding));
        mTagsPaddingBottom =
            typedArray.getDimensionPixelSize(R.styleable.TagsEditText_tagsPaddingBottom,
                ResourceUtils.getDimensionPixelSize(context, R.dimen.defaultTagsPadding));
      } finally {
        typedArray.recycle();
      }
  ...
  private void setTags() {
    ...
    if (str.endsWith(NEW_LINE)
        || (!mIsSpacesAllowedInTags && str.endsWith(mSeparator)) && !isDeleting) {
      buildTags(str);
    }
